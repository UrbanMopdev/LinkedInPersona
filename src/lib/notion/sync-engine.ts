  ...
  if (resolution === "keep_notion" && post.notion_page_id) {
    ...
    await supabase
      ...
      .update({
        ...
        platform: extracted.platform || post.platform,
        post_type: extracted.post_type || post.post_type,
  ...
  if (existingPost) {
    ...
    await supabase
      ...
      .update({
        ...
        target_icp: extracted.target_icp || existingPost.target_icp,
        tags: extracted.tags,
        notes: extracted.notes,
        sync_status: "synced",
    ...
    const { error } = await supabase.from("posts").insert({
      ...
      target_icp: extracted.target_icp,
      tags: extracted.tags,
      notes: extracted.notes,
